...
const BackofficeHomePage = () => {
  ...
  return (
    <main className="px-[20px] mt-10 xl:mt-16 max-w-[1000px] w-full">
      ...
      <div className="flex flex-col gap-y-6">
        <div className="bg-card flex flex-col xl:flex-row rounded-[3px] xl:py-16 xl:px-10 py-8 px-5 items-center">
          <Image unoptimized src={lessons} width={380} height={240} alt="Lessons" />
        ...
        <div className="bg-card flex flex-col xl:flex-row rounded-[3px] xl:py-16 xl:px-10 py-8 px-5 items-center">
          <Image unoptimized src={courses} width={380} height={240} alt="Courses" />
          <div className="flex flex-col xl:ml-8 xl:mt-0 mt-4">
